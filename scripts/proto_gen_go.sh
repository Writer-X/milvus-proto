...
$protoc --proto_path="${GOOGLE_PROTO_DIR}" --proto_path=. \
    --go_opt="Mmilvus.proto=github.com/Writer-X/milvus-proto/go-api/v2/milvuspb;milvuspb" \
    --go_opt=Mcommon.proto=github.com/Writer-X/milvus-proto/go-api/v2/commonpb \
    --go_opt=Mschema.proto=github.com/Writer-X/milvus-proto/go-api/v2/schemapb \
    --go_out=plugins=grpc,paths=source_relative:./../go-api/milvuspb milvus.proto

$protoc --proto_path="${GOOGLE_PROTO_DIR}" --proto_path=. \
    --go_opt=Mmilvus.proto=github.com/Writer-X/milvus-proto/go-api/v2/milvuspb \
    --go_opt=Mcommon.proto=github.com/Writer-X/milvus-proto/go-api/v2/commonpb \
    --go_opt="Mschema.proto=github.com/Writer-X/milvus-proto/go-api/v2/schemapb;schemapb" \
    --go_out=plugins=grpc,paths=source_relative:./../go-api/schemapb schema.proto

$protoc --proto_path="${GOOGLE_PROTO_DIR}" --proto_path=. \
    --go_opt=Mmilvus.proto=github.com/Writer-X/milvus-proto/go-api/v2/milvuspb \
    --go_opt="Mcommon.proto=github.com/Writer-X/milvus-proto/go-api/v2/commonpb;commonpb" \
    --go_opt=Mschema.proto=github.com/Writer-X/milvus-proto/go-api/v2/schemapb \
...
$protoc --proto_path="${GOOGLE_PROTO_DIR}" --proto_path=. \
    --go_opt=Mschema.proto=github.com/Writer-X/milvus-proto/go-api/v2/schemapb \
    --go_opt=Mcommon.proto=github.com/Writer-X/milvus-proto/go-api/v2/commonpb \
    --go_opt="Mmessage.proto=github.com/Writer-X/milvus-proto/go-api/v2/msgapb;msgpb" \
    --go_out=plugins=grpc,paths=source_relative:./../go-api/msgpb msg.proto

$protoc --proto_path="${GOOGLE_PROTO_DIR}" --proto_path=. \
    --go_opt=Mschema.proto=github.com/Writer-X/milvus-proto/go-api/v2/schemapb \
    --go_opt=Mcommon.proto=github.com/Writer-X/milvus-proto/go-api/v2/commonpb \
    --go_opt="Mmessage.proto=github.com/Writer-X/milvus-proto/go-api/v2/federpb;federpb" \
